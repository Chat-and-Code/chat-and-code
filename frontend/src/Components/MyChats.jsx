import { Avatar, Box, Button, Divider, Stack, Text, Tooltip } from "@chakra-ui/react";
    ...
    <>
      ...
      >
        <Box
          ...
          alignItems="center"
        >
          <Text fontSize={{ base: "20px", md: "17px", lg: "20px" }} fontWeight={'100'} color={'white'}>
            My Chats
          </Text>
          ...
          <Tooltip label="New Group Chat" hasArrow placement="bottom-end">
              ...
              <Button rightIcon={<AiOutlineUsergroupAdd size="30px" />}>
